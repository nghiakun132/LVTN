        ...
        if (!$("#" + this_menu_clone_id).length) {
          ...
          thisClone.find("[id]").each(function () {
            ...
            thisClone
              ...
              .attr("href", "#" + MERCADO_JS.mercado_add_string_prefix($(this).attr("id"), "mercado-clone-"))
          ...
          $(".mercado-clone-wrap .mercado-panels #mercado-main-panel ul").append(
      ...
      $(document).on("click", ".mercado-prev-panel", function (e) {
        ...
        if (typeof new_parent_panel_id == "undefined" || typeof new_parent_panel_id == false) {
          ...
          item_title = $("#" + new_parent_panel_id)
            .find('.mercado-next-panel[data-target="' + target_id + '"]')

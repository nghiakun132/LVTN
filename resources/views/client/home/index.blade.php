        ...
        <div class="container">
                        ...
                        <div class="wrap-main-slide">
                            <div class="slide-carousel owl-carousel style-nav-1" data-items="1" data-loop="1"
                                ...
                                <div class="item-slide">
                                    <img src="{{ asset('client/assets/images/main-slider-1-1.jpg') }}" alt=""
                                        class="img-slide" />
                                ...
                                <div class="item-slide">
                                    <img src="{{ asset('client/assets/images/main-slider-1-2.jpg') }}" alt=""
                                        class="img-slide" />
                                ...
                                <div class="item-slide">
                                    <img src="{{ asset('client/assets/images/main-slider-1-3.jpg') }}" alt=""
                                        class="img-slide" />
                                    <div class="slide-info slide-3">
                                        <h2 class="f-title">Great Range of <b>Exclusive Furniture Packages</b></h2>
                                        <span class="f-subtitle">Exclusive Furniture Packages to Suit every
                                            need.</span>
                        ...
                        <div class="wrap-banner style-twin-default">
                            <div class="banner-item">
                                <a href="#" class="link-banner banner-effect-1">
                                    <figure><img src="{{ asset('client/assets/images/home-1-banner-1.jpg') }}"
                                            alt="" width="580" height="190" /></figure>
                                </a>
                            </div>
                            <div class="banner-item">
                                <a href="#" class="link-banner banner-effect-1">
                                    <figure><img src="{{ asset('client/assets/images/home-1-banner-2.jpg') }}"
                                            alt="" width="580" height="190" /></figure>
                                </a>
                            </div>
                        </div>
                ...
                <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5"
                    ...
                    <div class="product product-style-2 equal-elem">
                        <div class="product-thumnail">
                            <a href="detail.html" title="T-Shirt Raw Hem Organic Boro Constrast Denim">
                                <figure>
                                    <img src="{{ asset('client/assets/images/products/kidtoy_05.jpg') }}"
                                        width="800" height="800"
                                        alt="T-Shirt Raw Hem Organic Boro Constrast Denim" />
                                </figure>
                            </a>
            ...
            <div class="wrap-show-advance-info-box style-1" id="LATESTPRODUCTS">
                ...
                <div class="wrap-top-banner">
                    <a href="#" class="link-banner banner-effect-2">
                        <figure>
                            <img src="{{ asset('client/assets/images/digital-electronic-banner.jpg') }}" width="1170"
                                height="240" alt="" />
                        </figure>
                    </a>
                </div>
                                ...
                                <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container"
                                    ...
                                    <div class="product product-style-2 equal-elem">
                                        <div class="product-thumnail">
                                            <a href="detail.html" title="T-Shirt Raw Hem Organic Boro Constrast Denim">
                                                <figure>
                                                    <img src="{{ asset('client/assets/images/products/digital_17.jpg') }}"
                                                        width="800" height="800"
                                                        alt="T-Shirt Raw Hem Organic Boro Constrast Denim" />
                                                </figure>
                                            </a>
            ...
            <div class="wrap-show-advance-info-box style-1" id="PRODUCTCATEGORIES">
                ...
                <div class="wrap-top-banner">
                    <a href="#" class="link-banner banner-effect-2">
                        <figure>
                            <img src="{{ asset('client/assets/images/fashion-accesories-banner.jpg') }}" width="1170"
                                height="240" alt="" />
                        </figure>
                    </a>
                </div>

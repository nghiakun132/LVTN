...
Route::group(['namespace' => 'Admin', 'prefix' => 'panel'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'staff', 'middleware' => ['role']], function () {
            ...
            Route::get('/{id}/edit', [StaffController::class, 'show'])->name('admin.staff.show');
            Route::post('/{id}/edit', [StaffController::class, 'update'])->name('admin.staff.update');
            Route::get('/{id}/delete', [StaffController::class, 'delete'])->name('admin.staff.delete');
            Route::get('/{id}/change-status', [StaffController::class, 'changeStatus'])->name('admin.staff.changeStatus');
        });

        Route::group(['prefix' => 'category'], function () {
            Route::get('', [CategoryController::class, 'index'])->name('admin.category.index');
            Route::post('', [CategoryController::class, 'store'])->name('admin.category.store');
            Route::get('/{id}/edit', [CategoryController::class, 'show'])->name('admin.category.show');
            ...
            Route::get('/{id}/change-status', [CategoryController::class, 'changeStatus'])->name('admin.category.changeStatus');
        });

        Route::group(['prefix' => 'brand'], function () {
            Route::get('', [BrandController::class, 'index'])->name('admin.brand.index');
            Route::post('', [BrandController::class, 'store'])->name('admin.brand.store');
            Route::get('/{id}/edit', [BrandController::class, 'show'])->name('admin.brand.show');
            ...
            Route::get('/{id}/change-status', [BrandController::class, 'changeStatus'])->name('admin.brand.changeStatus');
        ...
        Route::group(['prefix' => 'product'], function () {
            ...
            Route::get('/{id}/edit', [ProductController::class, 'show'])->name('admin.product.show');
            ...
            Route::get('/{id}/change-status', [ProductController::class, 'changeStatus'])->name('admin.product.changeStatus');
            Route::get('/{id}/detail', [ProductController::class, 'detail'])->name('admin.product.detail');
            // Route::post('/{id}/detail', [ProductController::class, 'detailPost'])->name('admin.product.detailPost');
            ...
            Route::post('/{id}/add-sales', [ProductController::class, 'addSalesPost'])->name('admin.product.addSalesPost');
            Route::get('/{id}/delete-sales', [ProductController::class, 'deleteSales'])->name('admin.product.deleteSale');
        ...
        Route::group(['prefix' => 'coupon'], function () {
            ...
            Route::get('/{id}/edit', [CouponController::class, 'show'])->name('admin.coupon.show');
            Route::post('/{id}/edit', [CouponController::class, 'update'])->name('admin.coupon.update');
            Route::get('/{id}/delete', [CouponController::class, 'delete'])->name('admin.coupon.delete');
        });
        ...
        Route::group(['prefix' => 'import'], function () {
            ...
            Route::get('changeStatus/{id}', [ImportController::class, 'changeStatus'])->name('admin.import.changestatus');
        });
        ...
        Route::group(['prefix' => 'event'], function () {
            ...
            Route::get('/{id}/edit', [EventController::class, 'show'])->name('admin.event.show');
            Route::post('/{id}/edit', [EventController::class, 'update'])->name('admin.event.update');
            Route::get('/{id}/delete', [EventController::class, 'delete'])->name('admin.event.delete');
            Route::get('/check', [EventController::class, 'check'])->name('admin.event.check');
            Route::get('/delete-detail', [EventController::class, 'deleteDetail'])->name('admin.event.deleteDetail');
        });
        ...
        Route::group(['prefix' => 'comment'], function () {
            ...
            Route::get('/{id}/delete', [CommentController::class, 'delete'])->name('admin.comment.delete');
        ...
        Route::group(['prefix' => 'order'], function () {
            ...
            Route::get('/{id}/change-status', [OrderController::class, 'changeStatus'])->name('admin.order.confirm');
        ...
        Route::group(['prefix' => 'delivery'], function () {
            ...
            Route::get('/{id}/edit', [DeliveryController::class, 'edit'])->name('admin.delivery.edit');
            Route::post('/{id}/edit', [DeliveryController::class, 'update'])->name('admin.delivery.update');
            Route::get('/{id}/delete', [DeliveryController::class, 'destroy'])->name('admin.delivery.delete');
            Route::get('/{id}/change-status', [DeliveryController::class, 'changeStatus'])->name('admin.delivery.confirm');
        });

        Route::group(['prefix' => 'user'], function () {
            Route::get('', [UserController::class, 'index'])->name('admin.user.index');
            Route::post('/active', [UserController::class, 'active'])->name('admin.user.active');
            Route::get('/{id}/delete', [UserController::class, 'destroy'])->name('admin.user.delete');
            Route::get('/{id}/change-status', [UserController::class, 'changeStatus'])->name('admin.user.confirm');
        });
    });
});
